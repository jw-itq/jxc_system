...
public class SupplierServiceImpl implements SupplierService{
	...
	@Override
	public List<Supplier> list(final Supplier supplier, Integer page, Integer pageSize, Direction direction, String... properties) {
			...
			public Predicate toPredicate(Root<Supplier> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if(supplier!=null){
					if(StringUtil.isNotEmpty(supplier.getName())){
						predicate.getExpressions().add(cb.like(root.<String>get("name"), "%"+supplier.getName()+"%"));
					}
				}
				return predicate;
			}
	...
	@Override
	public Long getCount(final Supplier supplier) {
