...
public class CustomerServiceImpl implements CustomerService{
	...
	@Override
	public List<Customer> list(final Customer customer, Integer page, Integer pageSize, Direction direction, String... properties) {
			...
			public Predicate toPredicate(Root<Customer> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if(customer!=null){
					if(StringUtil.isNotEmpty(customer.getName())){
						predicate.getExpressions().add(cb.like(root.<String>get("name"), "%"+customer.getName()+"%"));
					}
				}
				return predicate;
			}
	...
	@Override
	public Long getCount(final Customer customer) {
